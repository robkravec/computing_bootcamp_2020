...
```{r ex2_part2}
gap_canada = gap %>% filter(country == "Canada")

ggplot(data = gap_canada, mapping = aes(x = gdpPercap, y = lifeExp)) + geom_point(color = "red") + geom_line()
```
...
```{r ex2_part3}
gap_africa_1992 = gap %>% filter(continent == "Africa", year == 1992)

ggplot(data = gap_africa_1992, mapping = aes(x = gdpPercap, y = lifeExp)) + 
...
```{r ex3_part1}
gap_africa_europe = gap %>% filter(continent %in% c("Africa", "Europe"), year 
   == 1992)

ggplot(data = gap_africa_europe, mapping = aes(x = gdpPercap, y = lifeExp, 
...
ggplot(data = gap_2007, aes(x = continent, y = gdpPercap)) + 
